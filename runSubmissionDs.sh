...
java -cp "${current_home}/bin$LIBPATH" -Xms128m -Xmx2048m com.ethz.submissionds.AppStarter "/conf/config.test.properties"
#absolute path for server needed
#/exlibris/dps/d4_1/product/local/java/bin/java -cp "${current_home}/bin$LIBPATH" -Xms128m -Xmx2048m com.ethz.submissionds.AppStarter "/conf/config.properties"
