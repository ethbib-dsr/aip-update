...
public class Operation implements java.io.Serializable {
    ...
    // Constructor
    protected Operation(java.lang.String value) {
        _value_ = value;
    ...
    public static final Operation ADD = new Operation(_ADD);
    public static final Operation REPLACE = new Operation(_REPLACE);
    public static final Operation REMOVE = new Operation(_REMOVE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dps.exlibris.com/", "operation"));
    }
    /**
